...
public class JPACourseUpdatedEventHandler implements DomainEventHandler<DomainEvent> {
    ...
    private final JsonSerDe<CourseUpdatedEvent> jsonSerDe;

    public JPACourseUpdatedEventHandler(JpaDomainEventRepository jpaDomainEventRepository, DomainEventBus eventBus, InfrastructureEventBus infrastructureEventBus, JsonSerDe<CourseUpdatedEvent> jsonSerDe) {
        this.jpaDomainEventRepository = jpaDomainEventRepository;
        this.eventBus = eventBus;
        this.infrastructureEventBus = infrastructureEventBus;
        this.jsonSerDe = jsonSerDe;
        this.eventBus.subscribe(EventType.COURSE_UPDATED, this);
    }
