...
@Service
public class CourseDeletedEventsHandler implements Function<V1CourseCreatedInfrastructureEvent,Void> {
    private final KafkaTemplate<String, String> kafkaTemplate;
    private final InfrastructureEventBus eventBus;


    public CourseDeletedEventsHandler(KafkaTemplate<String, String> kafkaTemplate, InfrastructureEventBus eventBus) {
